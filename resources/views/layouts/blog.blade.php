...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5e181168b08c66ab"></script>
      ...
      <div class="container">
        ...
        <div class="navbar-left">
          <button class="navbar-toggler" type="button">&#9776;</button>
            ...
            <img class="logo-dark" src="{{ asset('img/favicon.png') }}" alt="logo">
            <img class="logo-light" src="{{ asset('img/favicon.png') }}" alt="logo">
          </a>
        </div>
